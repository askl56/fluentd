...
module Fluent::Config
  class TestLiteralParser < ::Test::Unit::TestCase
    ...
    sub_test_case 'array parsing' do
      ...
      test('["a","b"]') { assert_text_parsed_as_json(%w(a b), '["a","b"]') }
      test('[ "a" , "b" ]') { assert_text_parsed_as_json(%w(a b), '[ "a" , "b" ]') }
      test("[\n\"a\"\n,\n\"b\"\n]") { assert_text_parsed_as_json(%w(a b), "[\n\"a\"\n,\n\"b\"\n]") }
      test('["ab","cd"]') { assert_text_parsed_as_json(%w(ab cd), '["ab","cd"]') }
...
EOA
      test(json_array_with_js_comment) { assert_text_parsed_as_json(%w(a b c), json_array_with_js_comment) }
...
EOA
      test(json_array_with_comment) { assert_text_parsed_as_json(%w(a b c), json_array_with_comment) }
