...
class TestConfigTypes < ::Test::Unit::TestCase
  ...
  sub_test_case 'Config.size_value' do
    test 'normal case' do
      ...
      assert_equal(2048, Config.size_value('2K'))
      assert_equal(3_145_728, Config.size_value('3m'))
      assert_equal(3_145_728, Config.size_value('3M'))
      assert_equal(4_294_967_296, Config.size_value('4g'))
      assert_equal(4_294_967_296, Config.size_value('4G'))
      assert_equal(5_497_558_138_880, Config.size_value('5t'))
      assert_equal(5_497_558_138_880, Config.size_value('5T'))
  ...
  sub_test_case 'Config.time_value' do
    test 'normal case' do
      ...
      assert_equal(10_800, Config.time_value('3h'))
      assert_equal(345_600, Config.time_value('4d'))
    end
