...
module MixinTest
  module Utils
    ...
    module Checker
      extend self
      def format_check(_tag, _time, _record); end
    end
    ...
    def create_driver(include_klass, conf = '', tag = 'test', &block)
      ...
      klass = Class.new(Fluent::BufferedOutput) do
      ...
      Fluent::Test::BufferedOutputTestDriver.new(klass, tag) do
      end.configure("type #{register_output_name}" + conf)
    end
  end
  ...
  class SetTagKeyMixinText < Test::Unit::TestCase
    ...
    def test_tag_key_set
      format_check('tag_key_changed' => 'test',
                   'a' => 1)
    ...
    sub_test_case 'mixin' do
      ...
      test 'include_tag_key' do |param|
        d = create_driver(Fluent::SetTagKeyMixin) do
  ...
  class SetTimeKeyMixinText < Test::Unit::TestCase
    ...
    def test_include_time_key_true
      format_check('time' => '2010-05-04T03:02:01Z',
                   'a' => 1)
    ...
    def test_timezone_1
      format_check('time' => '2010-05-03T17:02:01-10:00',
                   'a' => 1)
    ...
    def test_timezone_2
      format_check('time' => '2010-05-04T08:32:01+05:30',
                   'a' => 1)
    ...
    sub_test_case 'mixin' do
      ...
      test 'include_time_key' do |param|
        d = create_driver(Fluent::SetTimeKeyMixin) do
