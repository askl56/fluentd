...
Gem::Specification.new do |gem|
  ...
  gem.description   = 'Fluentd is an open source data collector designed to scale and simplify log management. It can collect, process and ship many kinds of data in near real-time.'
  gem.summary       = 'Fluentd event collector'
